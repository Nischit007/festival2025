    ...
    <div className="h-auto bg-[#FAFDEE] w-full">
          ...
          <div className='flex flex-col gap-10 lg:text-7xl text-5xl py-20 px-20'>
            ...
            <div className="flex items-center gap-2 ">
             <h3  className='cursor-pointer font-[anton]'>LGBTQ</h3>
